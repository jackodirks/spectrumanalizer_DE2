...
# setting SOPC_SYSID_BASE_ADDRESS is 0x830f8
SOPC_SYSID_FLAG += --sidp=0x830f8
ELF_PATCH_FLAG  += --sidp 0x830f8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1389208005
SOPC_SYSID_FLAG += --timestamp=1389208005
ELF_PATCH_FLAG  += --timestamp 1389208005
